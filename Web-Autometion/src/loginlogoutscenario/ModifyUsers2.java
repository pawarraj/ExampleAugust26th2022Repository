...
public class ModifyUsers2 
{
		...
		@Test(priority = 6,dataProvider="modifying")
		private static void modifyUser(String mdata) 
		{
			...
			try
			{
				...
				oBrowser.findElement(By.id("userDataLightBox_emailField")).sendKeys(mdata);
				Thread.sleep(2000);
				WebElement mele = oBrowser.findElement(By.xpath("//*[@id=\'userDataLightBox_commitBtn\']/div/span"));
				Assert.assertTrue(mele.isDisplayed());
		...
		@DataProvider(name="modifying")
		public Object[] getmodifying()
		{
			return new Object[][] {{"demo1@gmail.com"}};
		}
